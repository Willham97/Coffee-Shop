...
Partial Class frmSchedual
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.ScheduleTableBindingSource.DataMember = "ScheduleTable"
        Me.ScheduleTableBindingSource.DataSource = Me.ProjectDatabaseDataSet
        '
        'ScheduleTableTableAdapter
        '
        Me.ScheduleTableTableAdapter.ClearBeforeFill = True
        '
        'TimeColumn
        '
